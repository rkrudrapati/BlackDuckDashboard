...
for each_project_request_response_items in project_request_response.json()["items"]:
    ...
    ## update login token for every 1000 rows of data
        # print(get_headers)
        ## update login token for every 1000 rows of data
    ...
    for each_version_request_response_items in version_request_response.json()["items"]:
        ...
        temp_lv = [critical_components_count, high_components_count, medium_components_count, low_components_count, critical_issues_count, high_issues_count, medium_issues_count, low_issues_count, age, Level]
